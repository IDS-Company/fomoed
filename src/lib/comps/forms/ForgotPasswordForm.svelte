...
<div>
	<h1 class="font-paralucent-demibold text-[32px]">Reset Password</h1>
	<div class="text-[#FFFFFFCC] pt-3 -desktop:text-sm">
		Enter your email and please wait to get the link for password reset
	</div>
