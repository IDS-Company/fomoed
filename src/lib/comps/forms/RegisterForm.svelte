...
<div>
	<h1 class="font-paralucent-demibold text-[32px]">Create an account</h1>
	<div class="text-[#FFFFFFCC] pt-[12px] -desktop:text-sm">
		Join the club and start you 30 day free trial.
	</div>
