<div class="flex flex-col items-center text-center">
	...
	<h1 class="font-paralucent-demibold text-[30px] pt-[24px]">Email Sent</h1>

	<div class="pt-[19px] text-[#FFFFFFCC]">
