	...
	theme: {
		extend: {
			...
			fontFamily: {
				...
				paralucent: ['var(--font-paralucent)', 'sans-serif'],
				'paralucent-demibold': ['var(--font-paralucent-demibold)', 'sans-serif'],
				'paralucent-heavy': ['var(--font-paralucent-heavy)', 'sans-serif'],
